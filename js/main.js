...
(function(html) {
    ...
    * ------------------------------------------------------ */
    const ssViewAnimate = function() {
        ...
        // Trigger once on page load to animate any blocks already in view
        viewportAnimation();
        ...
        function viewportAnimation() {
            ...
            blocks.forEach(function(current) {
                ...
                const elOffsetTop = current.getBoundingClientRect().top + scrollY;
                const triggerTop = (elOffsetTop + (viewportHeight * .2)) - viewportHeight;
